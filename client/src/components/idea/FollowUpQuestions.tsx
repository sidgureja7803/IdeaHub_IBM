...
const FollowUpQuestions: React.FC<FollowUpQuestionsProps> = ({
  ...
  useEffect(() => {
    const generateQuestions = async () => {
      ...
      try {
        // Call the backend to generate follow-up questions using IBM Granite
        ...
        {isLoading ? (
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2 max-w-md text-center">
              Our IBM Granite AI is processing your responses to create a comprehensive analysis.
            </p>
          </motion.div>
        ) : (
          <motion.div
          ...
          >
            ...
            >
              ...
              <button
                ...
                className={`inline-flex items-center justify-center px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${isCurrentAnswerValid() && !isSubmitting
